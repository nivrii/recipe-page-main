      ...
      <div className="divide-y divide-lightGrey mx-4">
        ...
        <div className="m-4">
          ...
          <ul className="font-outfit mt-2 mb-8 mx-4 text-darkCharcoal font-medium space-y-2">
            ...
            <li>
              <span className="text-nutmeg">5.</span>
              <span>Fold adn serve:</span> As the omelette continues to cook,
              carefully lift one edge and fold it over the fillings. Let it cook
              for another minute, then slide it onto a plate.
            </li>
            <li>
              <span className="text-nutmeg">6.</span>
