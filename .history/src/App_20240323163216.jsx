      ...
      <div className="divide-y divide-lightGrey mx-4">
        ...
        <div className="m-4">
          ...
          <ul className="font-outfit mt-2 mb-8 mx-4 text-nutmeg font-medium space-y-2 bg-blue-300">
            ...
            <li className="flex flex-row">
              <div className="text-nutmegLight font-bold basis-1/8">2.</div>
              <div className="basis-1/2 grow">
            ...
            <li className="flex flex-row">
              <div className="text-nutmegLight font-bold basis-1/8">3.</div>
              <div className="basis-1/2 grow">
            ...
            <li className="flex flex-row">
              <div className="text-nutmegLight font-bold basis-1/8">4.</div>
              <div className="basis-1/2 grow">
            ...
            <li className="flex flex-row">
              <div className="text-nutmegLight font-bold basis-1/8">5.</div>
              <div className="basis-1/2 grow">
            ...
            <li className="flex flex-row">
              <div className="text-nutmegLight font-bold basis-1/8">6.</div>
              <div className="basis-1/2 grow">
