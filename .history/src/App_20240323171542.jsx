        ...
        <div className="m-4">
          ...
          <div className="divide-y-2 divide-lightGrey bg-red-200">
            <div className="flex flex-row my-2">
              <span className="basis-1/2 mx-auto">Calories</span>
              <span className="basis-1/2 mx-auto">277kcal</span>
            </div>
            <div className="flex flex-row my-2">
              <span className="basis-1/2 mx-auto">Carbs</span>
              <span className="basis-1/2 mx-auto">0g</span>
            </div>
            <div className="flex flex-row my-2">
              <span className="basis-1/2 mx-auto">Protein</span>
              <span className="basis-1/2 mx-auto">20g</span>
            </div>
            <div className="flex flex-row my-2">
              <span className="basis-1/2 mx-auto">Fat</span>
              <span className="basis-1/2 mx-auto">22g</span>
            </div>
          </div>
        </div>
      </div>
