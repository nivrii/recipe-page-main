        ...
        <div className="m-4">
          ...
          <div className="divide-y-2 divide-lightGrey bg-red-200">
            <div className="flex flex-row my-2">
              <span className="basis-1/2 text-center">Calories</span>
              <span className="basis-1/2 text-center">277kcal</span>
            </div>
            <div className="flex flex-row my-2">
              <span className="basis-1/2 text-center">Carbs</span>
              <span className="basis-1/2 text-center">0g</span>
            </div>
            <div className="flex flex-row my-2">
              <span className="basis-1/2 text-center">Protein</span>
              <span className="basis-1/2 text-center">20g</span>
            </div>
            <div className="flex flex-row my-2">
              <span className="basis-1/2 text-center">Fat</span>
              <span className="basis-1/2 text-center">22g</span>
            </div>
          </div>
        </div>
      </div>
