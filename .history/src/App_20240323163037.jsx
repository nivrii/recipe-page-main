    ...
    <div className="container flex flex-col md:p-4 md:bg-eggshell w-screen min-h-max">
      ...
      <div className="divide-y divide-lightGrey mx-4">
        ...
        <div className="m-4">
          ...
          <ul className="font-outfit mt-2 mb-8 mx-4 text-nutmeg font-medium space-y-2 bg-blue-300">
            <li className="flex flex-row">
              <div className="text-nutmegLight font-bold basis-1/8">1.</div>
              <div className="basis-1/2 bg-red-400 w-screen">
            ...
            <li className="flex flex-row">
              <div className="text-nutmegLight font-bold basis-1/6">2.</div>
            ...
            <li className="flex flex-row">
              <div className="text-nutmegLight font-bold basis-1/6">3.</div>
              <div className="basis-1/2">
            ...
            <li className="flex flex-row">
              <div className="text-nutmegLight font-bold basis-1/6">4.</div>
              <div className="basis-1/2">
            ...
            <li className="flex flex-row">
              <div className="text-nutmegLight font-bold basis-1/6">5.</div>
              <div className="basis-1/2">
            ...
            <li className="flex flex-row">
              <div className="text-nutmegLight font-bold basis-1/6">6.</div>
              <div className="basis-1/2">
