    ...
    <div className="container flex flex-col md:p-4 md:bg-eggshell w-screen min-h-max">
      ...
      <div className="m-8">
        ...
        <ul className="list-disc px-4 text-outfit">
          <li className=" font-semibold my-8">2 - 3 large eggs</li>
          <li className=" font-semibold my-8">Salt to taste</li>
          <li className=" font-semibold my-8">Pepper to taste</li>
          <li className=" font-semibold my-8">1 tablespoon of butter or oil</li>
          <li className=" font-semibold my-8">
