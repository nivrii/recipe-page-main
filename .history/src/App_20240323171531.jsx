        ...
        <div className="m-4">
          ...
          <div className="divide-y-2 divide-lightGrey bg-red-200">
            <div className="flex flex-row my-2">
              <span className="basis-1/2 ml-4">Calories</span>
              <span className="basis-1/2 ml-4">277kcal</span>
            </div>
            <div className="flex flex-row my-2">
              <span className="basis-1/2 ml-4">Carbs</span>
              <span className="basis-1/2 ml-4">0g</span>
            </div>
            <div className="flex flex-row my-2">
              <span className="basis-1/2 ml-4">Protein</span>
              <span className="basis-1/2 ml-4">20g</span>
            </div>
            <div className="flex flex-row my-2">
              <span className="basis-1/2 ml-4">Fat</span>
              <span className="basis-1/2 ml-4">22g</span>
            </div>
          </div>
        </div>
      </div>
