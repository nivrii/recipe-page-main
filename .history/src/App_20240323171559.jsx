    ...
    <div className="container flex flex-col md:p-4 md:bg-eggshell w-screen min-h-max">
      ...
      <div className="divide-y-2 divide-lightGrey mx-4 ">
        ...
        <div className="m-4">
          ...
          <div className="divide-y-2 divide-lightGrey bg-red-200">
            <div className="flex flex-row my-2">
              <span className="basis-1/2 justify-center">Calories</span>
              <span className="basis-1/2 justify-center">277kcal</span>
            </div>
            <div className="flex flex-row my-2">
              <span className="basis-1/2 justify-center">Carbs</span>
              <span className="basis-1/2 justify-center">0g</span>
            </div>
            <div className="flex flex-row my-2">
              <span className="basis-1/2 justify-center">Protein</span>
              <span className="basis-1/2 justify-center">20g</span>
            </div>
            <div className="flex flex-row my-2">
              <span className="basis-1/2 justify-center">Fat</span>
              <span className="basis-1/2 justify-center">22g</span>
            </div>
          </div>
        </div>
      </div>
