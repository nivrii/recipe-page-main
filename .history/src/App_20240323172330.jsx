    ...
    <div className="container flex flex-col md:p-4 md:bg-eggshell w-screen min-h-max">
      ...
      <div className="divide-y-2 divide-lightGrey mx-4 ">
        ...
        <div className="m-4">
          ...
          <div className="grid grid-cols-1 divide-y divide-lightGrey">
            <div className="flex flex-row my-4 text-center align-middle">
              <span className="basis-1/2">Calories</span>
              <span className="basis-1/2">277kcal</span>
            </div>
            <div className="flex flex-row my-4 text-center align-middle">
              <span className="basis-1/2">Carbs</span>
              <span className="basis-1/2">0g</span>
            </div>
            <div className="flex flex-row my-4 text-center align-middle">
              <span className="basis-1/2">Protein</span>
              <span className="basis-1/2">20g</span>
            </div>
            <div className="flex flex-row my-4 text-center align-middle">
              <span className="basis-1/2">Fat</span>
              <span className="basis-1/2">22g</span>
            </div>
          </div>
        </div>
      </div>
