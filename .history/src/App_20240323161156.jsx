      ...
      <div className="divide-y divide-lightGrey mx-4">
        ...
        <div className="m-4">
          ...
          <ul className="font-outfit mt-2 mb-8 mx-4 text-nutmeg font-medium space-y-2 ">
            <li>
              <span className="text-nutmegLight font-bold">1.</span>
