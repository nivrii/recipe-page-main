    ...
    <div className="container flex flex-col md:p-4 md:bg-eggshell w-screen min-h-max">
      ...
      <div className="divide-y divide-lightGrey mx-4">
        ...
        <h1 className="text-left text-nutmegLight text-4xl font-bold font-young mt-8 mb-4">
          ...
          <p className="text-nutmeg font-semibold text-outfit">The table below shows nutritional values per serving without the additional fillings.</p>
          <div className="divide-y divide-lightGrey  ">
            <div className="flex flex-row "><span className="basis-1/2">Calories</span><span className="basis-1/2">277kcal</span></div>
            <div className="flex flex-row "><span className="basis-1/2">Carbs</span><span className="basis-1/2">0g</span></div>
            <div className="flex flex-row "><span className="basis-1/2">Protein</span><span className="basis-1/2">20g</span></div>
            <div className="flex flex-row "><span className="basis-1/2">Fat</span><span className="basis-1/2">22g</span></div>
          </div>
        </div>
      </div>
    </div>
