    ...
    <div className="container flex flex-col md:p-4 md:bg-eggshell w-screen min-h-max">
      ...
      <div className="divide-y-2 divide-lightGrey mx-4 ">
        ...
        <div className="m-4">
          ...
          <p className="text-nutmeg font-semibold text-outfit">
            The table below shows nutritional values per serving without the
            additional fillings.
          </p>
          <div className="divide-y divide-lightGrey text-outline">
            <div className="flex flex-row my-2 text-center">
              <span className="basis-1/2 text-nutmeg font-semibold">Calories</span>
              <span className="basis-1/2 text-nutmegLight font-bold">277kcal</span>
            </div>
            <div className="flex flex-row my-2 text-center">
              <span className="basis-1/2 text-nutmeg font-semibold">Carbs</span>
              <span className="basis-1/2 text-nutmegLight font-bold">0g</span>
            </div>
            <div className="flex flex-row my-2 text-center">
              <span className="basis-1/2 text-nutmeg font-semibold">Protein</span>
              <span className="basis-1/2 text-nutmegLight font-bold">20g</span>
            </div>
            <div className="flex flex-row my-2 text-center">
              <span className="basis-1/2 text-nutmeg font-semibold">Fat</span>
              <span className="basis-1/2 text-nutmegLight font-bold">22g</span>
            </div>
          </div>
        </div>
      </div>
