        ...
        <div className="m-4">
          ...
          <div className="divide-y divide-lightGrey">
            <div className="flex flex-row my-2 text-center">
              <span className="basis-1/2 text-nutmeg">Calories</span>
              <span className="basis-1/2 text-nutmegLight font-bold">277kcal</span>
            </div>
            <div className="flex flex-row my-2 text-center">
              <span className="basis-1/2 text-nutmeg">Carbs</span>
              <span className="basis-1/2 text-nutmegLight font-bold">0g</span>
            </div>
            <div className="flex flex-row my-2 text-center">
              <span className="basis-1/2 text-nutmeg">Protein</span>
              <span className="basis-1/2 text-nutmegLight font-bold">20g</span>
            </div>
            <div className="flex flex-row my-2 text-center">
              <span className="basis-1/2 text-nutmeg">Fat</span>
