    ...
    <div className="container flex flex-col md:p-4 md:bg-eggshell w-screen min-h-max">
      ...
      <div className="divide-y divide-lightGrey mx-4">
        ...
        <div className="m-4">
          ...
          <ul className="font-outfit mt-2 mb-8 mx-4 text-darkCharcoal font-medium space-y-2">
            <li>
              <span className="text-nutmeg">1.</span>
              <span>Beat the eggs:</span>In a bowl, beat the eggs with a pinch
              of salt and pepper until they are well mixed. You can add a
              tablespoon of water and milk for a fluffier texture.
            </li>
            <li>
              <span className="text-nutmeg font-bold">2.</span>
              <span className="text-wengeBrown">Heat the pan:</span> Place a non-stick frying pan over
              medium heat and add butter or oil.
            </li>
            <li>
              <span className="text-nutmeg font-bold">3.</span>
              <span className="text-wengeBrown">Cook the omelette:</span> Once the butter is melted and
              bubbling, pour in the eggs. Tilt the pan to ensure the eggs evenly
              coat the surface.
            </li>
            <li>
              <span className="text-nutmeg font-bold">4.</span>
              <span className="text-wengeBrown">Add fillings(optional):</span> When the eggs begin to set at
              the edges but are still slightly runny in the middle, sprinkle
              your chosen fillings over one half of the omelette.
            </li>
            <li>
              <span className="text-nutmeg font-bold">5.</span>
              <span className="text-wengeBrown">Fold and serve:</span> As the omelette continues to cook,
              carefully lift one edge and fold it over the fillings. Let it cook
              for another minute, then slide it onto a plate.
            </li>
            <li>
              <span className="text-nutmeg font-bold">6.</span>
              <span className="text-wengeBrown">Enjoy:</span> Serve hot, with additional salt and pepper if
              needed.
            </li>
          </ul>
        </div>
