    ...
    <div className="container flex flex-col md:p-4 md:bg-eggshell w-screen min-h-max">
      ...
      <div className="bg-roseWhite p-4 mx-8 rounded-xl">
        ...
        <ul className="list-disc p-4">
          <li className="text-nutmeg"><span className="font-extrabold">Total:</span> Approximately 10 minutes</li>
          <li className="text-nutmeg"><span className="font-extrabold">Preparation:</span> 5 minutes</li>
          <li className="text-nutmeg"><span className="font-extrabold">Cooking:</span> 5 minutes</li>
        </ul>
      </div>
    </div>
  );
