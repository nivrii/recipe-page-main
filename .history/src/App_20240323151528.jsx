    ...
    <div className="container flex flex-col md:p-4 md:bg-eggshell w-screen min-h-max">
      ...
      <div className="m-8">
        ...
        <ul className="list-disc px-4 text-outfit">
          <li className=" font-semibold my-2">2 - 3 large eggs</li>
          <li className=" font-semibold my-2">Salt to taste</li>
          <li className=" font-semibold my-2">Pepper to taste</li>
          <li className=" font-semibold my-2">1 tablespoon of butter or oil</li>
          <li className=" font-semibold my-2">
