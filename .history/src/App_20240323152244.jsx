  ...
  return (
    <div className="container flex flex-col md:p-4 md:bg-eggshell w-screen min-h-max">
      ...
      <div className="m-8">
        ...
        <ul className="list-disc px-4 font-outfit my-2 mx-4 text-nutmeg font-medium">
          <li className="flex align-middle">2-3 large eggs</li>
          <li className="flex align-middle">Salt to taste</li>
          <li className="flex align-middle">Pepper to taste</li>
          <li className="flex align-middle">1 tablespoon of butter or oil</li>
