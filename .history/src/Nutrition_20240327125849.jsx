  ...
  return (
    <div className="m-4 mb-8 md:mx-0">
      ...
      <div className="divide-y divide-lightGrey font-outfit md:text-xl">
        <div className="flex flex-row my-2 mx-12 text-left">
          <p className="basis-1/2 text-nutmeg font-semibold ml:4">Calories</p>
        ...
        <div className="flex flex-row my-2   text-left">
          <p className="basis-1/2 text-nutmeg font-semibold mx-12">Protein</p>
