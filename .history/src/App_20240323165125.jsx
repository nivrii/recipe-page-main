      ...
      <div className="divide-y divide-lightGrey mx-4">
        ...
        <h1 className="text-left text-nutmegLight text-4xl font-bold font-young mt-8 mb-4">
          ...
          <div className="divide-y divide-lightGrey  ">
            <div className="flex flex-row"><span>Calories</span><span>277kcal</span></div>
            <div className="flex flex-row"><span>Carbs</span><span>0g</span></div>
            <div className="flex flex-row"><span>Protein</span><span>20g</span></div>
            <div className="flex flex-row"><span>Fat</span><span>22g</span></div>
          </div>
        </div>
      </div>
    </div>
