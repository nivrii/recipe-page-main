    ...
    <div className="container flex flex-col md:p-4 md:bg-eggshell w-screen min-h-max">
      ...
      <div className="bg-roseWhite p-4 mx-8 rounded-xl">
        ...
        <ul className="list-disc p-4">
          <li><span className="font-semibold">Total:</spanc> Approximately 10 minutes</li>
          <li><span className="font-semibold">Preparation:</spanc> 5 minutes</li>
          <li><span className="font-semibold">Cooking:</spanc> 5 minutes</li>
        </ul>
      </div>
    </div>
  );
