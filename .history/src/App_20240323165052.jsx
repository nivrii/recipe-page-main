    ...
    <div className="container flex flex-col md:p-4 md:bg-eggshell w-screen min-h-max">
      ...
      <div className="divide-y divide-lightGrey mx-4">
        ...
        <h1 className="text-left text-nutmegLight text-4xl font-bold font-young mt-8 mb-4">
          ...
          <div className="divide-y divide-lightGrey flex flex-col ">
            <div><span>Calories</span><span>277kcal</span></div>
            <div><span>Carbs</span><span>0g</span></div>
            <div><span>Protein</span><span>20g</span></div>
            <div><span>Fat</span><span>22g</span></div>
          </div>
        </div>
      </div>
    </div>
