...
function App() {
  return (
    <div className="container flex flex-col md:p-4 md:bg-eggshell w-screen min-h-max">
      ...
      <div className="m-8">
        <h1 className="text-left text-nutmegLight text-4xl font-bold font-young ">
          Ingredients
        </h1>
        <ul className="list-disc px-4 font-outfit text-nutmeg font-extralight">
          <li className=" font-semibold my-2 mx-4">2-3 large eggs</li>
          <li className=" font-semibold my-2 mx-4">Salt to taste</li>
          <li className=" font-semibold my-2 mx-4">Pepper to taste</li>
          <li className=" font-semibold my-2 mx-4">1 tablespoon of butter or oil</li>
          <li className=" font-semibold my-2 mx-4">
